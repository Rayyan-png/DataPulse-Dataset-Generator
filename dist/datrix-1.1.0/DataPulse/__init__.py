from .agriculture_data import generate_agricultural_data

from .assets_data import generate_asset_management_data

from .audio_data import generate_audio_data

from .banking_transaction import generate_banking_transaction_data
...
from .demographics_data import generate_demographic_data

from .educational_data import generate_educational_data

from .Energy_consumption_data import generate_energy_consumption_data
...
from .medical_data import generate_medical_data

from .NLP_data import generate_nlp_data

from .online_learning_data import generate_online_learning_data

from .pension_data import generate_pension_data

from .real_state_data import generate_real_estate_data

from .retail_data import generate_retail_data

from .sales_data import generate_sale_date

from .sentiment_data import generate_sentiment_data

from .social_media_data import generate_social_media_data
